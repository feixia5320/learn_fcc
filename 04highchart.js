...
function quanxian_pic3(){
   ...
   var plotOptions = {
      line: {
         ...
         enableMouseTracking: true,//鼠标提示框
      }
   };
   var series= [{
         name: 'Tokyo',
   ...
   json.yAxis = yAxis;  
   json.series = series;
   json.plotOptions = plotOptions;//曲线上的标签
   $('#container3').highcharts(json);
}
//带有标签曲线图
quanxian_pic3();
//------------------------------------可缩放的图表------------------------------------
function quanxian_scale(){
var chart = {
      zoomType: 'x'
   }; 
   var title = {
   ...
   var series= [{
      ...
      data: [
         0.9, 0.8, 0.7, 0.8451,    0.8418, 0.8264,    0.8258, 0.8232,    0.8233, 0.8258,
